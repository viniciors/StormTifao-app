...
export default function HomeScreen({ navigation, route }) {
  ...
  // Sempre que a rota receber reload, refaz a lista
  useEffect(() => {
  ...
  // Sempre que a tela ganha foco, refaz a lista
  useEffect(() => {
  ...
  const fetchShelters = () => {
    getShelters()
      ...
      .catch(() => {
        Alert.alert('Erro', 'Não foi possível carregar abrigos.');
      });
  };
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: () => {
            deleteShelter(shelterId)
              ...
              .catch(() =>
                Alert.alert('Erro', 'Falha ao excluir abrigo.')
              );
          }
        }
      ]
            ...
            <View key={shelter.id} style={styles.listItemContainer}>
              ...
              <View style={styles.actionButtons}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate('ShelterForm', { shelter })
                  }
                >
